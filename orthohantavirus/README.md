1) The first file is the 'Creating Orthohantavirus dataset from NCBI Virus data.ipynb' file. The file contains the code for creating the orthohantavirs dataset. Using the codes of this file, the dataset was generated from the curated orthohantavirus data from NCBI Virus Data.
